...
export class SalesforceAdapter extends BaseGRCAdapter {
  ...
  async writeRiskControlMapping(
    ...
    if (this.useLive) {
      try {
        // First: Write the mapping narrative to the risk record's ai_recommendation__c field
        ...
        console.log(`[Salesforce LIVE UPDATE] Updated grc__Risk__c ${riskSysId}.ai_recommendation__c with mapping narrative`);
